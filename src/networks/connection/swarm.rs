...
pub async fn create_swarm(
    ...
    let mut swarm = {
        ...
        let key_B = identity::Keypair::from_protobuf_encoding(&peers::P1KEY).expect("Decoding Error");
        let id_B = PeerId::from(key_B.public());
        let dst_addr_via_relay = Multiaddr::empty()
            ...
            .with(Protocol::P2p(id_B.into())); // Destination peer id. (Peer A)
