...
use crate::{plane_creator::geometry::bevy_ui, components::comps};
...
pub fn update_assets(mut plane_assets: &mut PlaneAssets, filename: String, tags: HashSet<String>) {
    plane_assets.assets.insert(filename, tags);
}

pub fn delete_asset(mut plane_assets: &mut PlaneAssets, filename: String) {
